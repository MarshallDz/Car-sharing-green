...
class VistaCliente(QMainWindow):
    def __init__(self, cliente):
        ...
        self.delete_button = QPushButton("Elimina account")
        ...
        self.delete_button.clicked.connect(self.elimina)
    ...
    def crea_campo(self, nome, valore):
        ...
        campo.setStyleSheet("margin-right: 200px; max-width: 200px; min-height: 40px; background-color: #e3e1dc; "
                            "color: black")
    ...
    def modifica(self):
        ...
        self.delete_button.clicked.disconnect(self.elimina)
        self.delete_button.clicked.connect(self.annulla)
        ...
        self.delete_button.setText("Annulla")

    def annulla(self):
        self.modify_button.clicked.disconnect(self.conferma)
        self.delete_button.clicked.disconnect(self.annulla)
        self.modify_button.clicked.connect(self.modifica)
        self.delete_button.clicked.connect(self.elimina)
        self.email.setReadOnly(True)
        self.email.setStyleSheet("margin-right: 200px; max-width: 200px; min-height: 40px; background-color: #e3e1dc; color: black")
        ...
        self.modify_button.clicked.connect(self.modifica)
        self.delete_button.setText("Elimina account")
        self.delete_button.clicked.connect(self.elimina)
    ...
    def elimina(self):
        reply = QMessageBox.warning(self, 'Conferma Cancellazione', 'Sei sicuro di voler eliminare il tuo account?',
                                    QMessageBox.Yes, QMessageBox.No)

        if reply == QMessageBox.Yes:
            cliente = Cliente()
            cliente.eliminaCliente(self.cliente)
