...
class PrenotazioneMoto(QWidget):
    ...
    def aggiungi_box_moto(self, moto):
        ...
        tariffaLabel = QLabel(f"A partire da {moto['tariffaOraria']}€ ad ora \n oppure  {int(int(moto['tariffaOraria']) * 24 * 0.7)}€ al giorno")
    ...
    def go_prenota(self, moto):
        self.vista_prenotazione = VistaEffettuaPrenotazione(self.cliente, moto)
